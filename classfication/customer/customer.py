# Customer 클래스 생성
# 멤버변수 - 고객아이디, 이름, 등급, 보너스포인트, 보너스 적림률
# 멤버함수 - get(), set() 함수로 작성함
# 보너스 포인트 - 가격 * 보너스 적립률
class Customer:
    ...
    def __str__(self):
        return f'{self.cname}님의 등급은 {self.cgrade}이고, ' \
               f'보너스 포인트 {self.bonus_point}점 입니다.'
...
if __name__=="__main__":
    ...
    print(f'{c1.getname()}님의 구매비용은 {cost1}원 입니다.')
    print(c1)
    ...
    print(f'{c2.getname()}님의 구매비용은 {cost2}원 입니다람쥐~.')
    print(c2)
